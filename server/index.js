...
import xuatHopDongWordRouter from './routes/xuat-hop-dong-word.js';
import xuatBbbgExcelRouter from './routes/xuat-bbbg-excel.js';
import xuatDeNghiWordRouter from './routes/xuat-de-nghi-word.js';
import phuLucHopDongRouter from './routes/phu-luc-hop-dong.js';
import xuatPhuLucWordRouter from './routes/xuat-phu-luc-word.js';
...
import congNoRouter from './routes/cong-no.js';
...
app.use('/api', xuatHopDongWordRouter);
app.use('/api', xuatBbbgExcelRouter);
app.use('/api', xuatDeNghiWordRouter);
app.use('/api', phuLucHopDongRouter);
app.use('/api', xuatPhuLucWordRouter);
